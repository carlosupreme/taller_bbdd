...
public class EditarMunicipioModal extends javax.swing.JDialog {

    private final MunicipioRepository municipioRepository;
    private final long idEntidad;
    private final long idMunicipio;
    private final MunicipiosFrame parent;

    public EditarMunicipioModal(java.awt.Frame parent, MunicipioRepository municipioRepository, long idEntidad, long idMunicipio) {
        super(parent, true);
        initComponents();
        this.municipioRepository = municipioRepository;
        this.idEntidad = idEntidad;
        this.idMunicipio = idMunicipio;
        this.parent = (MunicipiosFrame) parent;

        try {
            Municipio municipio = municipioRepository.findById(idEntidad, idMunicipio);
    ...
    private void initComponents() {
        ...
        tituloLbl.setText("Editar municipio");
        ...
        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 530, 50));
        ...
        jPanel2.add(nombrePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 560, -1));
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        try {
            Municipio municipio = new Municipio(idEntidad, Long.valueOf(id.getText().trim()), nombre.getText().trim());
            municipioRepository.update(idEntidad, idMunicipio, municipio);

            dispose();
            parent.loadEntries();
            MessageHandler.showSuccessMessage("Municipio actualizado", null);
        } catch (SQLException | ValidationModelException ex) {
            MessageHandler.showErrorMessage(ex.getMessage());
        }
