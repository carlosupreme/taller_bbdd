...
public class CrearMunicipioModal extends javax.swing.JDialog {

    private final MunicipioRepository municipioRepository;
    private final MunicipiosFrame parent;
    private final Entidad entidad;
    
    public CrearMunicipioModal(java.awt.Frame parent, MunicipioRepository municipioRepository, Entidad entidad) {
        super(parent, true);
        initComponents();
        ...
        this.tituloLbl.setText("Crear municipio de " + entidad.getNombre());
    ...
    private void initComponents() {
        ...
        tituloLbl.setText("Crear Municipio de Michoacan");
    ...
    private void agregarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarBtnActionPerformed
        try {
            municipioRepository.save(new Municipio(entidad.getId(),Long.parseLong(idTextField.getText().trim()), nombreTextField.getText().trim()));

            dispose();
            parent.loadEntries();
            MessageHandler.showSuccessMessage("Municipio creado", null);
