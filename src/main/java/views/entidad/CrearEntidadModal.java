...
public class CrearEntidadModal extends javax.swing.JDialog {

    private final EntidadRepository entidadRepository;
    private final EntidadesFrame parent;

    public CrearEntidadModal(java.awt.Frame parent, EntidadRepository entidadRepository) {
        super(parent, true);
        initComponents();
        ...
        RealTimeValidator.addValidation(identidadTextField, new ValidationRule(this::esIdValido, idError));
    ...
    private void initComponents() {
        ...
        identidadTextField = new javax.swing.JTextField();
        ...
        identidadTextField.setToolTipText("");
        identidadTextField.setActionCommand("<Not Set>");
        identidadTextField.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        identidadTextField.setMargin(new java.awt.Insets(2, 10, 2, 6));
        identidadTextField.setOpaque(true);
        identidadTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                identidadTextFieldKeyTyped(evt);
            }
        });
        nombrePanel.add(identidadTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 400, 40));
        ...
        tituloLbl.setText("Crear Entidad");
    ...
    private void agregarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarBtnActionPerformed
        try {
            entidadRepository.save(new Entidad(Long.parseLong(identidadTextField.getText().trim()), nombreTextField.getText().trim()));

            dispose();
            parent.loadEntries();
            MessageHandler.showSuccessMessage("Entidad creada", null);
        } catch (SQLException ex) {
            if (ex.getErrorCode() == 1062) {
                MessageHandler.showErrorMessage("El <id> ya está registrado, intenta con otro");
                identidadTextField.selectAll();
                identidadTextField.requestFocus();
            }
        } catch (ValidationModelException ex) {
    ...
    private void identidadTextFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_identidadTextFieldKeyTyped
        if(!agregarBtn.isEnabled()){
            agregarBtn.setEnabled(true);
        }
    }//GEN-LAST:event_identidadTextFieldKeyTyped
    ...
    private javax.swing.JTextField identidadTextField;
